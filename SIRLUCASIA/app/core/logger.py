...
class Logger:
    ...
    def info(self, module, command, message):
        self._write(LoggerLevel.INFO, module, command, message)

    def warning(self, module, command, message):
        self._write(LoggerLevel.WARNING, module, command, message)

    def error(self, module, command, message):
        self._write(LoggerLevel.ERROR, module, command, message)
